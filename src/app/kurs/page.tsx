...
const courses = [
  { id: 1, title: "Assistentkurs", description: "Vi tilbyr et intensivt 30-timers kurs for deg som ønsker å bli helseassistent. Kurset gir deg en grundig innføring i de grunnleggende ferdighetene du trenger for å arbeide på sykehjem eller i andre institusjoner. Opplæringen går over én uke og avsluttes med en to timers prøve, som sikrer at du har tilegnet deg nødvendig kunnskap og kompetanse.", price: "kr 5 000,-", alignRight: true },
  { id: 2, title: "Helsefagarbeider teori", description: "Vi tilbyr et omfattende 50-timers teorikurs for assistenter som ønsker å bli helsefagarbeidere. Kurset dekker sentrale temaer som grunnleggende sykdomslære, kommunikasjon, yrkesforståelse og anatomi. Undervisningen er basert på fagbøkene fra helsearbeiderutdanningen, slik at du får et solid teoretisk grunnlag for videre utvikling i yrket.", price: "kr 10 000,-", alignRight: false },
  { id: 3, title: "Eksamensforberende kurs", description: "Vi tilbyr et intensivt 10-timers kurs for å forberede deg best mulig. Kurset består av 6 timer gruppeundervisning og 4 timer individuell veiledning, skreddersydd etter dine spesifikke behov for å sikre at du er godt forberedt. Vi er så trygge på at kurset vårt vil hjelpe deg å lykkes, at vi tilbyr en gratis gjennomgang av eksamensoppgaven din i etterkant dersom du ikke skulle bestå.", price: "kr 10 000,-", alignRight: true },
